...
public class PatientMain extends javax.swing.JFrame {
    ...
    public PatientMain(Patient patient) {
        ...
        patientMenu.initMoving(PatientMain.this);
        patient_FormHome = new Patient_FormHome(this.patient);
        patient_FormAccount = new Patient_FormAccount(this.patient);
        patient_FormAppointment = new Patient_FormAppointment();
        patient_FormHistory = new Patient_FormHistory(this.patient.getUserName(), this);
        patient_FormChat = new Patient_FormChat(this.patient);
        ...
        setForm(new Patient_FormHome(this.patient));
    }
    ...
    private void initComponents() {
        ...
        pateintBorderPanel1Layout.setHorizontalGroup(
                pateintBorderPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(pateintBorderPanel1Layout.createSequentialGroup()
                                .addComponent(patientMenu, javax.swing.GroupLayout.PREFERRED_SIZE, 187,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGroup(pateintBorderPanel1Layout
                                        .createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(pateintBorderPanel1Layout.createSequentialGroup()
                                                .addGap(0, 0, 0)
                                                .addComponent(patientHeader1, javax.swing.GroupLayout.PREFERRED_SIZE,
                                                        875, javax.swing.GroupLayout.PREFERRED_SIZE))
                                        .addGroup(pateintBorderPanel1Layout.createSequentialGroup()
                                                .addGap(0, 0, 0)
        ...
        pateintBorderPanel1Layout.setVerticalGroup(
                pateintBorderPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(pateintBorderPanel1Layout.createSequentialGroup()
                                .addComponent(patientHeader1, javax.swing.GroupLayout.PREFERRED_SIZE, 26,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(0, 0, 0)
                                .addComponent(Patient_mainPanel, javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientMain.class.getName()).log(java.util.logging.Level.SEVERE, null,
                    ex);
        ...
        // public void run() {
        // new PatientMain(patient).setVisible(true);
        // }
        // });
    }

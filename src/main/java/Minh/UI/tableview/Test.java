...
public class Test extends javax.swing.JFrame {
    ...
    private Object[] getRandomRow(String name) {
        ...
        return new Object[] { false, name, "$" + df.format(getAmount(9999, 9999999)),
                "$" + df.format(getAmount(9999, 9999999)), df.format(getAmount(-100, 100)) };
    }
    ...
    private void applyTableStyle(JTable table) {
        ...
        txtSearch.putClientProperty(FlatClientProperties.TEXT_FIELD_TRAILING_ICON,
                new FlatSVGIcon("tableview/icon/search.svg", 0.35f));
        // Change scroll style

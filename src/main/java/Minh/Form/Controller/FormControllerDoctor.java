...
public class FormControllerDoctor {
    ...
    private void buildDoctor() {
        ...
        if (viewDoctor.getRdoMale().isSelected()) {
            modelDoctor.setGender("Male");
        } else if (viewDoctor.getRdoFemale().isSelected()) {
            modelDoctor.setGender("Female");
        } else {
            modelDoctor.setGender("Other");
        }

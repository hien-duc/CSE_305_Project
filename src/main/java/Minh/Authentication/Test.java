...
public class Test {
        ...
        public static void main(String[] args) {
                ...
                Patient patient1 = new Patient("1990-05-15", "Software Engineer", "Health Insurance Inc.", "175 cm",
                                "70 kg",
                                "A+",
                                "a", "John Doe", "123-456-7890", "john.doe@example.com", "Male", "a");

                // Example 2: Creating a Patient instance with different values
                Patient patient2 = new Patient("1985-08-20", "Doctor", "Medical Insurance Corp.", "180 cm", "85 kg",
                                "B-",

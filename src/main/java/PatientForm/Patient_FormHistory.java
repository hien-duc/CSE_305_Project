...
public class Patient_FormHistory extends javax.swing.JPanel {
    ...
    private void testData() {
        ...
        for (int i = 0; i < payments.size(); i++) {
            ...
            String report = payments.get(i).getReports();
            double money = payments.get(i).getMoney();
            String date = payments.get(i).getDate();
            String moneyStr = Double.toString(money);
            model.addRow(new String[] { name, illness, medication, report, moneyStr, date });
        }
    ...
    private void initComponents() {
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Name", "Illness", "Medication", "Reports", "Payment", "Date"
            }
        ) {

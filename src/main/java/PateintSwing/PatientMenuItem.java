...
public class PatientMenuItem extends javax.swing.JPanel {

    //Data members
    protected boolean selected;
    protected boolean over;

    public PatientMenuItem(PatientModel_Menu data) {
        initComponents();
        setOpaque(false);
        if (data.getType() == PatientModel_Menu.MenuType.MENU) {
            lblIcon.setIcon(data.toIcon());
            lblName.setText(data.getName());
        } else if (data.getType() == PatientModel_Menu.MenuType.TITLE) {

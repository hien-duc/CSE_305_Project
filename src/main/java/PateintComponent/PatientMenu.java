...
public class PatientMenu extends javax.swing.JPanel {
    ...
    private void init() {
        patientList_Menu1.addItem(new PatientModel_Menu("icons8-dashboard-24", "Dashboard", PatientModel_Menu.MenuType.MENU));
        patientList_Menu1.addItem(new PatientModel_Menu("icons8-account-24", "Account", PatientModel_Menu.MenuType.MENU));
        patientList_Menu1.addItem(new PatientModel_Menu("icons8-person-calendar-24", "Appointment", PatientModel_Menu.MenuType.MENU));
        patientList_Menu1.addItem(new PatientModel_Menu("icons8-activity-history-24", "History", PatientModel_Menu.MenuType.MENU));
        ...
        patientList_Menu1.addItem(new PatientModel_Menu("", " ", PatientModel_Menu.MenuType.EMPTY));
        patientList_Menu1.addItem(new PatientModel_Menu("", " ", PatientModel_Menu.MenuType.EMPTY));
        patientList_Menu1.addItem(new PatientModel_Menu("icons8-open-pane-24", "Log-out", PatientModel_Menu.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        lblPatientNameMenuSide.setText("OHMS");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(37, 37, 37)
                .addComponent(PatientpanelMoving, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addComponent(patientList_Menu1, javax.swing.GroupLayout.DEFAULT_SIZE, 258, Short.MAX_VALUE))
        );
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jLabel1)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(lblPatientNameMenuSide, javax.swing.GroupLayout.PREFERRED_SIZE, 16, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                    ...
                    .addComponent(patientList_Menu1, javax.swing.GroupLayout.PREFERRED_SIZE, 387, javax.swing.GroupLayout.PREFERRED_SIZE)))
        );
    }// </editor-fold>//GEN-END:initComponents

    public void fillData() {
////        System.out.println(patient.getName());
//        String text = lblPatientNameMenuSide.getText();
//        if (text != null) {
//            lblPatientNameMenuSide.setText(patient.getName());
//        } else {
//            lblPatientNameMenuSide.setText(patient.getName());
//        }
    }

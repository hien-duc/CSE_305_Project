...
public class DoctorMenu extends javax.swing.JPanel {
    ...
    private void init() {
        doctorList_Menu1
                .addItem(new DoctorModel_Menu("icons8-dashboard-24", "Dashboard", DoctorModel_Menu.MenuType.MENU));
        doctorList_Menu1.addItem(new DoctorModel_Menu("icons8-account-24", "Account", DoctorModel_Menu.MenuType.MENU));
        doctorList_Menu1.addItem(
                new DoctorModel_Menu("icons8-person-calendar-24", "Appointment", DoctorModel_Menu.MenuType.MENU));
        ...
        doctorList_Menu1
                .addItem(new DoctorModel_Menu("icons8-open-pane-24", "Log-out", DoctorModel_Menu.MenuType.MENU));
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                                .addComponent(PatientpanelMoving,
                                ...
                                .addGap(21, 21, 21))
                        .addComponent(doctorList_Menu1, javax.swing.GroupLayout.Alignment.TRAILING,
                        ...
                        .addGroup(layout.createSequentialGroup()
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addComponent(jLabel3)))
                                .addGap(18, 18, 18)
                                .addComponent(doctorList_Menu1, javax.swing.GroupLayout.DEFAULT_SIZE, 406,
                                        Short.MAX_VALUE)
                                .addContainerGap()));

...
public class Login extends JPanel {
        ...
        private void init() {
                ...
                panelChange.putClientProperty(FlatClientProperties.STYLE, "" +
                                "background:null");
                btnChangeToLogin = new JButton("<html><a href=\"#\">Sign up</a></html>");
                ...
                panelChange.add(btnChangeToLogin);
                panel.add(panelChange);
                add(panel);
        }

        // public Component createSignupLabel() {
        // JPanel panelChange = new JPanel(new FlowLayout(FlowLayout.CENTER, 0, 0));
        // panelChange.putClientProperty(FlatClientProperties.STYLE, "" +
        // "background:null");
        // JButton btnChangeToLogin = new JButton("<html><a href=\"#\">Sign
        // up</a></html>");
        // btnChangeToLogin.putClientProperty(FlatClientProperties.STYLE, "" +
        // "border:3,3,3,3");
        // btnChangeToLogin.setContentAreaFilled(false);
